...
<script>
  ...
  export default {
    ...
    created() {
      ...
      const theme = localStorage.getItem('arccosx-admin-theme')
      if (null !== theme) {
    ...
    methods: {
      ...
      handleSetTheme() {
        ...
        document.getElementsByTagName(
          'body'
        )[0].className = `arccosx-admin-theme-${name}`
      ...
      handleSetDfaultTheme() {
        ...
        document
          ...
          .classList.remove(`arccosx-admin-theme-${name}`)
        localStorage.removeItem('arccosx-admin-theme')
      ...
      handleGetCode() {
        const url =
          'https://github.com/chuzhixin/arccosx-admin/tree/master/src/views'
