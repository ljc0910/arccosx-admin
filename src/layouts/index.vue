<template>
  <div class="arccosx-admin-wrapper" :class="classObj">
    <div
  ...
  export default {
    ...
    mounted() {
      ...
      if (userAgent.includes('Juejin')) {
        this.$baseAlert(
          'arccosx-admin不支持在掘金内置浏览器演示，请手动复制以下地址到浏览器中查看http://mpfhrd48.sanxing.uz7.cn/arccosx-admin'
        )
      }
