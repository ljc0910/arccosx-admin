      ...
      handleCommand(command) {
        switch (command) {
          ...
          case 'personalCenter':
            ...
            break
          case 'github':
            window.open('https://github.com/chuzhixin/arccosx-admin')
            break
          case 'gitee':
            window.open('https://gitee.com/chu1204505056/arccosx-admin')
            break
          case 'pro':
            window.open(
              'https://arccosx-admin.com/admin-pro/?hmsr=homeAd&hmpl=&hmcu=&hmkw=&hmci='
            )
            break
          case 'plus':
            window.open(
              'https://arccosx-admin.com/admin-plus/?hmsr=homeAd&hmpl=&hmcu=&hmkw=&hmci='
            )
        }
      },
      personalCenter() {
